...
class Person:
    ...
    def __init__(self, name):
        self.name = name
        self.words = 'I squirreled it away before it could catch on fire.'
    ...
    def greet(self):
        self.words = "Hello, my name is " + self.name
...
class Round:
    ...
    def is_complete(self):
        ...
        return self.highest > -1 and self.next_player == self.starter
