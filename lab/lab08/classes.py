...
class TutorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        if player.hand:
            ...
            added = True
        """
        player.hand += [player.hand[0].copy()] creates a new object and adds 
        it to the list, while player.hand += [player.hand[0]] 
        adds a reference to an existing object to the list.
        """
        if added:
